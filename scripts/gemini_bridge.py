...
if __name__ == "__main__":
    ...
    # Import run_bridge and Dispatcher from dispatcher module
    ...
    # Pass the script-level callables directly to run_bridge via dependency
    # injection instead of monkey-patching module-level functions.
    run_bridge(
        user_req,
        cfg,
        dispatcher,
