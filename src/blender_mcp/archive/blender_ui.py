"""Archived copy of the legacy Blender UI module.

Kept for historical/reference reasons after migrating the UI into
`src/blender_mcp/blender_ui/` package. This file is not imported by the
package; it's purely archival.
"""
