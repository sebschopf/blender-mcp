"""Server helpers moved into the `servers` package.

This is a relocated copy of the top-level `server.py`. Relative imports are
adjusted so the module lives under `blender_mcp.servers`.
"""
