...
The real Panel class is created when `bpy` is available. At import time
we provide a lightweight placeholder so tests and import-time checks don't
fail in CI.
"""
...
try:
    ...
    # real Panel and should not be registered.

    class BLENDERMCP_PT_Panel:  # type: ignore
        pass
