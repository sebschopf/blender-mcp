...
Validation
----------
- Run `openspec validate --strict openspec/changes/0019-asgi-lifespan` in repo root to validate spec format.
- Ensure the PR body references this change id `0019-asgi-lifespan`.
