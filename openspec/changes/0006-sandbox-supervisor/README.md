...
Proposal: Harden `embedded_server_adapter` by running external workloads in isolated, resource-limited environments and add a supervisor that enforces restart policies and resource limits.
